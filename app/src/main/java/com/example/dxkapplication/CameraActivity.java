...
import com.example.dxkapplication.Camera;
import com.example.dxkapplication.CameraAdapter;
                        ...
                        try {
                            ...
                            for (int i = 0; i < featuresArray.length(); i++) {
                                ...
                                for (int j = 0; j < camerasArray.length(); j++) {
                                    ...
                                    String cameDescription = camera.getString("Description");
                                    ...
                                    cameraList.add(new Camera(cameDescription, camImageURL));
                                }
                            }
